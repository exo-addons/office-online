package org.exoplatform.officeonline.test;
...
public class AbstractResourceTest extends BaseCommonsTestCase {
  ...
  protected OfficeOnlineEditorService officeonlineEditorService;
  ...
  protected void beforeClass() {
    ...
    this.officeonlineEditorService = getContainer().getComponentInstanceOfType(OfficeOnlineEditorService.class);
  }
  ...
  protected ContainerResponse service(String method,
    ...
    HttpServletRequest httpRequest =
                                   new OfficeOnlineMockHttpServletRequest("", in, in != null ? in.available() : 0, method, headers);
  ...
  protected String createTestDocument(String user, String title, String content) throws Exception {
    ...
    session.save();
    String docId = officeonlineEditorService.initDocument(node);
    Config config = officeonlineEditorService.createEditor("http", "localhost", 8080, user, null, docId);
