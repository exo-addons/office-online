...
import static org.exoplatform.officeonline.webui.OfficeOnlineContext.editorLink;
...
/**
 * Listener that will initialize Officeonline integration for ECMS Documents app.
 * <br>
 * Created by The eXo Platform SAS.
 * 
 * @author <a href="mailto:pnedonosko@exoplatform.com">Peter Nedonosko</a>
 * @version $Id: OfficeOnlineDocumentsLifecycle.java 00000 Mar 21, 2019 pnedonosko
 *          $
 */
public class OfficeOnlineDocumentsLifecycle extends AbstractOfficeOnlineLifecycle {
  ...
  /**
   * Instantiates a new Officeonline documents lifecycle.
   */
  public OfficeOnlineDocumentsLifecycle() {
    //
  }
    ...
    if (explorer != null && parentContext != null) {
      try {
        ...
        if (isNotSameUserDocument(userName, nodeWs, nodePath, parentContext)) {
          OfficeOnlineEditorService editorService = context.getApplication()
                                                         .getApplicationServiceContainer()
                                                         .getComponentInstanceOfType(OfficeOnlineEditorService.class);
