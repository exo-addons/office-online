...
/**
 * Open Officeonline editor in file view. Created by The eXo Platform SAS.
 * 
 * @author <a href="mailto:pnedonosko@exoplatform.com">Peter Nedonosko</a>
 * @version $Id: OfficeonlineComponent.java 00000 Mar 01, 2016 pnedonosko $
 */
...
public class OfficeOnlineOpenManageComponent extends UIAbstractManagerComponent {
   ...
   * <code>addOfficeonlineOpenActionListener</code> method. When the
  ...
  public String renderEventURL(boolean ajax, String name, String beanId, Parameter[] params) throws Exception {
    if (name.equals("OfficeonlineOpen")) {
      ...
      if (uiExplorer != null) {
        OfficeOnlineEditorService editorService = this.getApplicationComponent(OfficeOnlineEditorService.class);
