...
public class OfficeOnlineContext {
   ...
   */
  private OfficeOnlineContext(WebuiRequestContext requestContext) throws Exception {
    ...
    if (convo != null && convo.getIdentity() != null) {
      ...
      throw new OfficeOnlineEditorException("Authenticated user required");
    }
  }
   ...
   * @throws Exception the exception
   */
  private static OfficeOnlineContext context() throws Exception {
   ...
   * from
   * {@link OfficeOnlinePortalLifecycle#onStartRequest(org.exoplatform.web.application.Application, WebuiRequestContext)},
   ...
   *          {@link OfficeOnlineEditorService#getEditorLink(javax.jcr.Node)}
  ...
  public static String editorLink(String link, String source) {
    if (link != null && source != null) {
      ...
      // /portal/intranet/documents?path=.spaces.test_officeonline%2FGroups%2Fspaces%2Ftest_officeonline%2FDocuments%2FSimple+Document.docx
