...
import org.exoplatform.officeonline.documents.NewDocumentService;
 ...
 * 
 * Adopted from org.exoplatform.onlyoffice.webui.explorer.UINewDocumentForm
 * 
 */
@ComponentConfig(lifecycle = UIFormLifecycle.class, template = "classpath:groovy/templates/UINewMSDocument.gtmpl", events = {
    @EventConfig(listeners = UINewMSDocumentForm.SaveActionListener.class),
    @EventConfig(listeners = UINewMSDocumentForm.CancelActionListener.class, phase = Phase.DECODE) })
public class UINewMSDocumentForm extends UIForm implements UIPopupComponent {
  ...
  /** The Constant LOG. */
  protected static final Log   LOG                   = ExoLogger.getLogger(UINewMSDocumentForm.class.getName());
   ...
   * method is invoked.
   */
  static public class SaveActionListener extends EventListener<UINewMSDocumentForm> {

    /**
     * {@inheritDoc}
     */
    public void execute(Event<UINewMSDocumentForm> event) throws Exception {
      UINewMSDocumentForm uiDocumentForm = event.getSource();
   ...
   * method is invoked.
   */
  static public class CancelActionListener extends EventListener<UINewMSDocumentForm> {
