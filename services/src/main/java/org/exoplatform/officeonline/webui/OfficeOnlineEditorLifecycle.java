 ...
 */
public class OfficeOnlineEditorLifecycle extends AbstractOfficeOnlineLifecycle {

  /** The Constant EMPTY_PERMISSIONS. */
  public static final String[] EMPTY_PERMISSIONS       = new String[0];

  public static final String   EDITOR_STATES_ATTR_NAME = "OfficeOnlineContext.editor.states";

  /** The Constant LOG. */
  protected static final Log   LOG                     = ExoLogger.getLogger(OfficeOnlineEditorLifecycle.class);
  ...
  /**
   * Instantiates a new OfficeOnline editor lifecycle.
   */
  public OfficeOnlineEditorLifecycle() {
    // Nothing
  }
  ...
  public void onStartRequest(Application app, WebuiRequestContext context) throws Exception {
    ...
    if (servletRequest != null) {
      // States will be set by OfficeOnlineEditorFilter
