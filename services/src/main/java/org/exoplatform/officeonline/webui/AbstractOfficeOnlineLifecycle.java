 ...
 *          $
 */
public abstract class AbstractOfficeOnlineLifecycle implements ApplicationLifecycle<WebuiRequestContext> {

  /**
   * Instantiates a new abstract Officeonline lifecycle.
   */
  public AbstractOfficeOnlineLifecycle() {
    //
  }
