...
/**
 * Officeonline editor config for its JS API. <br>
...
public class Config implements Externalizable {
  ...
  public static class Builder {
    ...
    public Config build() {
      if (platformRestUrl != null) {
        this.url = new StringBuilder(platformRestUrl).append("/officeonline/editor/content/")
                                                     .append(userId)
                                                     .append("/")
                                                     .append(key)
                                                     .toString();
        this.callbackUrl = new StringBuilder(platformRestUrl).append("/officeonline/editor/status/")
                                                             .append(userId)
                                                             .append("/")
                                                             .append(key)
                                                             .toString();
  ...
  protected static String fileUrl(CharSequence baseUrl, String userId, String key) {
    return new StringBuilder(baseUrl).append("/officeonline/editor/content/").append(userId).append("/").append(key).toString();
  }
  ...
  protected static String callbackUrl(CharSequence baseUrl, String userId, String key) {
    return new StringBuilder(baseUrl).append("/officeonline/editor/status/").append(userId).append("/").append(key).toString();
  }
   ...
   * treated as not open nor not closed. When editor will be open in Officeonline
   ...
   * data submitted from Officeonline DS.
   */
