...
public class DocumentTypePlugin extends BaseComponentPlugin {
  ...
  public DocumentTypePlugin(InitParams initParams) {
    ...
    if (typesParam != null) {
      ...
      if (obj != null && OfficeOnlineEditorServiceImpl.DocumentTypesConfig.class.isAssignableFrom(obj.getClass())) {
        this.mimeTypes = OfficeOnlineEditorServiceImpl.DocumentTypesConfig.class.cast(obj).getMimeTypes();
      } else {
