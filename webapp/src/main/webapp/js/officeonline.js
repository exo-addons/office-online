  ...
  function Editor() {
    ...
    this.initEditor = function(config) {
      editorsupport.onEditorOpen(config.docId, config.workspace, ONLYOFFICE).done(function(){
          ...
          if (localConfig) {
            ...
            store.subscribe(function() {
              ...
              if (state.type === DOCUMENT_DELETED) {
                UI.showError(message("ErrorTitle"), message("ErrorAnotherEditorIsOpen"));
              }
        ...
        showError(message("ErrorTitle"), message("AnotherEditorIsOpen"));
      });
    };
    ...
    this.initEditorPage = function(link) {
      if (editorWindow != null) {
        if (link != null) {
          ...
          editorWindow.close();
          editorWindow = null;
          showError(message("ErrorTitle"), message("ErrorLinkNotFound"));
        }
      }
    };
